...
class ArticleScraper:
    ...
    def __init__(self, disable_cache=False, disable_robots_txt=False):
        ...
        self.xpath_schema = {
            ...
            "fields": [
                {
                    "name": "title",
                    "selector": "//h1[contains(@class, 'entry-title')]",
                    "type": "text"
                },
                {
                    "name": "content",
                    "selector": "//div[contains(@id, 'plpContainer')]",
                    "type": "html"
                }
            ]
        }
    ...
    "fields": [
        ...
        self.xpath_strategy = JsonXPathExtractionStrategy(self.xpath_schema)
    ...
    async def scrape_url(self, url: str) -> Optional[Dict[str, str]]:
        ...
        try:
            ...
            primary_config = CrawlerRunConfig(
                ...
                extraction_strategy=self.xpath_strategy,
